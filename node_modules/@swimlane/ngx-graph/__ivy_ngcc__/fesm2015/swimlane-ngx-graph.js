...
function GraphComponent__svg_g_1__svg_g_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function GraphComponent__svg_g_1__svg_g_7_Template__svg_g_click_0_listener() { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r15); const node_r8 = restoredCtx.$implicit; const ctx_r14 = ɵngcc0.ɵɵnextContext(2); return ctx_r14.onClick(node_r8); });
...
function GraphComponent__svg_g_1__svg_g_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function GraphComponent__svg_g_1__svg_g_11_Template__svg_g_click_0_listener() { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r29); const node_r22 = restoredCtx.$implicit; const ctx_r28 = ɵngcc0.ɵɵnextContext(2); return ctx_r28.onClick(node_r22); })("mousedown", function GraphComponent__svg_g_1__svg_g_11_Template__svg_g_mousedown_0_listener($event) { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r29); const node_r22 = restoredCtx.$implicit; const ctx_r30 = ɵngcc0.ɵɵnextContext(2); return ctx_r30.onNodeMouseDown($event, node_r22); });
...
function GraphComponent__svg_g_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("touchstart", function GraphComponent__svg_g_1_Template__svg_g_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r32); const ctx_r31 = ɵngcc0.ɵɵnextContext(); return ctx_r31.onTouchStart($event); })("touchend", function GraphComponent__svg_g_1_Template__svg_g_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r32); const ctx_r33 = ɵngcc0.ɵɵnextContext(); return ctx_r33.onTouchEnd($event); });
    ...
    ɵngcc0.ɵɵlistener("mousedown", function GraphComponent__svg_g_1_Template__svg_rect_mousedown_4_listener() { ɵngcc0.ɵɵrestoreView(_r32); const ctx_r34 = ɵngcc0.ɵɵnextContext(); return ctx_r34.isPanning = true; });
    ɵngcc0.ɵɵelementEnd();
...
function GraphComponent__svg_g_4__svg_g_4__svg_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵnamespaceSVG();
    ɵngcc0.ɵɵelementContainer(0, 19);
} if (rf & 2) {
...
function GraphComponent__svg_g_4__svg_g_4__svg_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵnamespaceSVG();
    ɵngcc0.ɵɵelementContainer(0, 19);
} if (rf & 2) {
    const node_r36 = ɵngcc0.ɵɵnextContext().$implicit;
...
function GraphComponent__svg_g_4__svg_g_4__svg_circle_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵnamespaceSVG();
    ɵngcc0.ɵɵelement(0, "circle", 29);
} if (rf & 2) {
    const node_r36 = ɵngcc0.ɵɵnextContext().$implicit;
...
function GraphComponent__svg_g_4__svg_g_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵnamespaceSVG();
...
function GraphComponent__svg_g_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mousedown", function GraphComponent__svg_g_4_Template__svg_rect_mousedown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r45); const ctx_r44 = ɵngcc0.ɵɵnextContext(); return ctx_r44.onMinimapPanTo($event); });
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵlistener("mousedown", function GraphComponent__svg_g_4_Template__svg_rect_mousedown_5_listener() { ɵngcc0.ɵɵrestoreView(_r45); const ctx_r46 = ɵngcc0.ɵɵnextContext(); return ctx_r46.onMinimapDragMouseDown(); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
GraphComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: GraphComponent, selectors: [["ngx-graph"]], contentQueries: function GraphComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, inputs: { legend: "legend", nodes: "nodes", clusters: "clusters", links: "links", activeEntries: "activeEntries", draggingEnabled: "draggingEnabled", panningEnabled: "panningEnabled", panningAxis: "panningAxis", enableZoom: "enableZoom", zoomSpeed: "zoomSpeed", minZoomLevel: "minZoomLevel", maxZoomLevel: "maxZoomLevel", autoZoom: "autoZoom", panOnZoom: "panOnZoom", animate: "animate", autoCenter: "autoCenter", enableTrackpadSupport: "enableTrackpadSupport", showMiniMap: "showMiniMap", miniMapMaxWidth: "miniMapMaxWidth", miniMapPosition: "miniMapPosition", groupResultsBy: "groupResultsBy", zoomLevel: "zoomLevel", panOffsetX: "panOffsetX", panOffsetY: "panOffsetY", layout: "layout", curve: "curve", nodeHeight: "nodeHeight", nodeMaxHeight: "nodeMaxHeight", nodeMinHeight: "nodeMinHeight", nodeWidth: "nodeWidth", nodeMinWidth: "nodeMinWidth", nodeMaxWidth: "nodeMaxWidth", update$: "update$", center$: "center$", zoomToFit$: "zoomToFit$", panToNode$: "panToNode$", layoutSettings: "layoutSettings", miniMapMaxHeight: "miniMapMaxHeight" }, outputs: { activate: "activate", deactivate: "deactivate", zoomChange: "zoomChange", clickHandler: "clickHandler" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature, ɵngcc0.ɵɵNgOnChangesFeature], ngContentSelectors: _c9, decls: 5, vars: 11, consts: [["mouseWheel", "", 3, "view", "showLegend", "legendOptions", "legendLabelClick", "legendLabelActivate", "legendLabelDeactivate", "mouseWheelUp", "mouseWheelDown"], ["class", "graph chart", 3, "touchstart", "touchend", 4, "ngIf"], ["class", "minimap", 4, "ngIf"], [1, "graph", "chart", 3, "touchstart", "touchend"], [3, "ngTemplateOutlet", 4, "ngIf"], ["class", "text-path", 4, "ngFor", "ngForOf"], [1, "panning-rect", 3, "mousedown"], [1, "clusters"], ["class", "node-group", 3, "old-node", "id", "click", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "links"], ["class", "link-group", 3, "id", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "nodes"], ["class", "node-group", 3, "old-node", "id", "click", "mousedown", 4, "ngFor", "ngForOf", "ngForTrackBy"], [3, "ngTemplateOutlet"], [1, "text-path"], [1, "node-group", 3, "id", "click"], ["clusterElement", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext", 4, "ngIf"], ["class", "node cluster", 4, "ngIf"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "node", "cluster"], ["alignment-baseline", "central"], [1, "link-group", 3, "id"], ["linkElement", ""], ["class", "edge", 4, "ngIf"], [1, "edge"], [1, "node-group", 3, "id", "click", "mousedown"], ["nodeElement", ""], ["r", "10", 4, "ngIf"], ["r", "10"], [1, "minimap"], [1, "minimap-background", 3, "mousedown"], [1, "minimap-nodes"], ["class", "node-group", 3, "old-node", "id", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "minimap-drag", 3, "mousedown"], [1, "node-group", 3, "id"]], template: function GraphComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: function () { return [ɵngcc1.ChartComponent, MouseWheelDirective, ɵngcc2.NgIf, ɵngcc2.NgForOf, ɵngcc2.NgTemplateOutlet]; }, styles: [".minimap .minimap-background{fill:rgba(0,0,0,.1)}.minimap .minimap-drag{cursor:pointer;fill:rgba(0,0,0,.2);stroke:#fff;stroke-dasharray:2px;stroke-dashoffset:2px;stroke-width:1px}.minimap .minimap-drag.panning{fill:rgba(0,0,0,.3)}.minimap .minimap-nodes{opacity:.5;pointer-events:none}.graph{-moz-user-select:none;-ms-user-select:none;-webkit-user-select:none;user-select:none}.graph .edge{fill:none;stroke:#666}.graph .edge .edge-label{fill:#251e1e;font-size:12px;stroke:none}.graph .panning-rect{cursor:move;fill:transparent}.graph .node-group.old-node{transition:transform .5s ease-in-out}.graph .node-group .node:focus{outline:none}.graph .cluster rect{opacity:.2}"], encapsulation: 2, changeDetection: 0 });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(GraphComponent, [{
        type: Component,
        args: [{
                selector: 'ngx-graph',
...
MouseWheelDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: MouseWheelDirective, selectors: [["", "mouseWheel", ""]], hostBindings: function MouseWheelDirective_HostBindings(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MouseWheelDirective, [{
        type: Directive,
...
GraphModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: GraphModule });
GraphModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [LayoutService], imports: [[ChartCommonModule]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(GraphModule, [{
        type: NgModule,
        args: [{
...
NgxGraphModule.ɵfac = function NgxGraphModule_Factory(t) { return new (t || NgxGraphModule)(); };
NgxGraphModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: NgxGraphModule });
NgxGraphModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[NgxChartsModule], GraphModule] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxGraphModule, [{
        type: NgModule,
        args: [{
